  ...
  return (
    <header>
      ...
      <div className="header-right" style={{ display: 'flex', alignItems: 'center' }}>
        <a href="https://x.com/fletcheragt" target="_blank" rel="noopener noreferrer" style={{ display: 'inline-flex', alignItems: 'center', justifyContent: 'center', marginRight: '16px', color: '#f2f2f2' }} aria-label="X (Twitter)">
