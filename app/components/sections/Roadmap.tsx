...
const phases = [
  {
    ...
    items: [
      ...
      { done: true,  text: "Safety Gate — 13-check token screen incl. honeypot round-trip simulation" },
    ],
  },
  {
    id: "phase-2",
    ...
    title: "LP Engine + Alpha Copy-Trade",
    period: "Q3 2026",
    items: [
      { done: true, text: "LP Engine — GMGN 24h pair screening (mcap/vol/meta filters)" },
      { done: true, text: "DAY mode: full-range LP on daily bigcap runners" },
      { done: true, text: "NIGHT mode: concentrated 3-pair overnight spray" },
      { done: true, text: "Fee-vs-IL hourly rule with auto-close proposal" },
      { done: true, text: "Compound engine: $500 → $2K cap per position, max 3" },
  ...
  },
  {
    ...
    items: [
      ...
      { done: false, text: "ERC-4337 session keys — scoped full-autonomous LP (no approvals, no custody)" },
